...
const AboutMe = () => {
  return (
    <section className="container">
      <div className='flex shadow-lg flex-col sm:flex-row items-center justify-center gap-5 md:gap-20 p-8 bg-white rounded-lg w-[80%] md:max-w-3xl mx-auto mt-10'>
      ...
      <div className="text-center mt-8 space-y-8 w-[80%] md:max-w-3xl mx-auto">
